export default {
  lineConnect: {
    ...
    captureMissingHint:
      'Screen recording permission is needed to read the game',
    requestPermission: 'Request capture permission',
    startCapture: 'Start capture',
    stopCapture: 'Stop capture',
    accessibility: 'Auto tap',
    accessibilityReadyHint:
      'Accessibility service is on — moves can be played automatically',
    accessibilityMissingHint:
      'Enable the "JieqiBox Auto Play" accessibility service in system settings',
    ...
    autoSideHint:
      'By default the app works out whether you play red or black. If it guesses wrong, pick red or black here, or tap the side button on the second row of the floating bar.',
    ...
    chessboardHint:
      'Opens a draggable, resizable board that shows the recognised position live',
    chessboardShow: 'Show board',
    chessboardHide: 'Hide board',
    chessboardShown: 'Board visible',
    samples: 'Sample collection',
    samplesHint:
      'Records screenshots together with the recognition result; label and export them to fine-tune the model',
    ...
    overlayReadyHint:
      'Keeps working after you switch to the game: shows status, can be dragged',
    overlayNoPermissionHint:
      'Requires the "display over other apps" permission',
    overlayNoServiceHint:
      'Start capture first — the floating bar attaches to the capture service',
    ...
    overlayTip:
      'Drag the status bar to move it; tap it to collapse or expand the button row. Buttons: New / Connect / Auto / Variation / Board / Side / Close. The side button on the second row switches between red and black if the guess is wrong.',
    ...
    blockAndroidOnly:
      'Not supported on this platform (line connect is Android only)',
    blockNoEngine:
      'No UCI engine loaded — open Engine manager to add and load one',
    blockNoCapture:
      'Screen capture is not running — grant capture permission and start it first',
    blockNoA11y:
      'Auto play needs the accessibility service — enable "JieqiBox Auto Play" in system settings; ignore this if you only want analysis',
    ...
    kindHintClassifier:
      'Detector locates the board, then each cell is classified',
    classifierClasses: 'Model classes',
    classifierNoBoard:
      'Could not locate the board — frame it manually in settings, or use a detection model',
    classifierMismatch:
      '{n} cells are outside the app class table; recognition may be off',
...
prev.prev - Previous-previous move (supports infinite nesting)`,
  ...
  tournament: {
    ...
    seed: 'Draw seed',
    seedHint:
      '0 leaves it to the app. A fixed seed makes the league replayable.',
    enginePick: 'Entrants (in order)',
    noEngines:
      'No engines configured yet — add them in the engine manager first.',
