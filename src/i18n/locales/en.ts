...
prev.prev - Previous-previous move (supports infinite nesting)`,
  ...
  tournament: {
    menuEntry: 'Engine Tournament',
    title: 'Engine Tournament',
    backToBoard: 'Back to board',
    export: 'Copy tournament data',
    create: 'New tournament',
    name: 'Name',
    namePlaceholder: 'Weekend league',
    defaultName: 'Engine tournament',
    format: 'Format',
    formatGauntlet: 'Gauntlet (first pick vs the rest)',
    formatRoundRobin: 'Round robin (everyone plays everyone)',
    timeControl: 'Time control',
    tcMovetime: 'Move time (ms)',
    tcNodes: 'Nodes per move',
    tcDepth: 'Depth',
    timeValue: 'Value',
    gamesPerPairing: 'Games per pairing',
    seed: 'Draw seed',
    seedHint: '0 leaves it to the app. A fixed seed makes the league replayable.',
    enginePick: 'Entrants (in order)',
    noEngines: 'No engines configured yet — add them in the engine manager first.',
    orderHint: 'The first pick is the challenger in a gauntlet.',
    createRun: 'Create schedule',
    pickTwo: 'Pick at least two engines.',
    pickOneMore: 'Pick one more engine.',
    created: 'Scheduled {total} games.',
    start: 'Start',
    resume: 'Continue',
    pause: 'Pause',
    abandon: 'Stop',
    delete: 'Delete',
    confirmDelete: 'Delete this tournament and every game it played?',
    exportCopied: 'Tournament data copied to the clipboard.',
    exportFailed: 'Could not copy the tournament data.',
    progress: '{done} played · {void} void · {total} scheduled · {status}',
    seedShort: 'seed {seed}',
    standings: 'Standings',
    engine: 'Engine',
    gamesShort: 'P',
