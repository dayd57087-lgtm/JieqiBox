export default {
  tournament: {
    ...
    create: '新建聯賽',
    name: '名稱',
    namePlaceholder: '週末聯賽',
    defaultName: '引擎聯賽',
    format: '賽制',
    formatGauntlet: '挑戰賽（首位挑戰其餘全部）',
    formatRoundRobin: '循環賽（兩兩對局）',
    timeControl: '時限方式',
    tcMovetime: '每步用時（毫秒）',
    tcNodes: '每步節點數',
    tcDepth: '搜尋深度',
    timeValue: '數值',
    gamesPerPairing: '每對局數',
    seed: '暗子種子',
    seedHint: '填 0 由程式決定；固定種子可完整重現整屆聯賽。',
    enginePick: '參賽引擎（順序即賽程）',
    ...
    abandon: '停止',
    delete: '刪除',
    confirmDelete: '刪除這屆聯賽及其全部對局記錄？',
    deleteYes: '確認刪除',
    deleteNo: '取消',
    exportCopied: '聯賽資料已複製到剪貼簿。',
    exportFailed: '複製聯賽資料失敗。',
    progress: '已賽 {done} 局 · 作廢 {void} 局 · 共 {total} 局 · {status}',
    seedShort: '種子 {seed}',
    standings: '積分榜',
    engine: '引擎',
    gamesShort: '場',
